        ...
        <el-col :span="6">
          ...
          <div class="left">
            ...
            <el-menu :default-active="$route.path" class="el-menu-vertical-demo">
              <el-menu-item index="/vipuser/certification" @click="changeActive('/vipuser/certification')">
                <el-icon>
                  <Calendar />
                </el-icon>
                <span>实名认证</span>
              </el-menu-item>
              <el-menu-item index="/vipuser/order" @click="changeActive('/vipuser/order')">
                <el-icon>
                  <Document />
                </el-icon>
                <span>挂号订单</span>
              </el-menu-item>
              <el-menu-item index="/vipuser/patient" @click="changeActive('/vipuser/patient')">
                <el-icon>
                  <Clock />
                </el-icon>
                <span>就诊人管理</span>
              </el-menu-item>
              <el-menu-item index="/vipuser/profile" @click="changeActive('/vipuser/profile')">
                <el-icon>
                  <Warning />
                </el-icon>
                <span>账号信息</span>
              </el-menu-item>
              <el-menu-item index="/vipuser/feedback" @click="changeActive('/vipuser/feedback')">
                <el-icon>
                  <Search />
                </el-icon>
                <span>意见反馈</span>
